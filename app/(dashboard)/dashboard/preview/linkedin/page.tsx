...
const LI = "#3A57E8"; // brand accent (this dashboard uses this theme everywhere — not LinkedIn blue)
// Brand shade ramp for donuts / ranked bars (dark → light).
...
export default function LinkedInPage() {
  return (
    <PreviewDashboardShell active="linkedin" title="LinkedIn" subtitle="Company page analytics — followers, posts, visitors, audience.">
