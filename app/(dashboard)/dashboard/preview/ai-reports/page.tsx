...
export default function AIReportsPage() {
  return (
    <PreviewDashboardShell active="ai-reports" title="Monthly Reports" subtitle="Generate the full performance report — weekly, monthly &amp; quarterly rollups across channels. Generated reports get stored under Reports.">
        ...
        <>
          ...
          <div className="flex items-center justify-between mb-4 flex-wrap gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => { if (savedMode) { window.location.href = "/dashboard/preview/reports/social"; } else { setReport(null); setSelectedPeriod(null); } }}
