...
export default function Page() {
  return (
    <PreviewDashboardShell active="sales" title="Counsellors" subtitle="How many leads each person holds, and how much of it has been worked." hideAccountPicker compact>
