...
export default function OrganicSalesPage() {
  return (
    <PreviewDashboardShell active="organic-sales" title="Organic Sales" hideAccountPicker subtitle="E-Book orders from the Marketing Hub — paid sales only, straight from Airtable. No paid promotion.">
