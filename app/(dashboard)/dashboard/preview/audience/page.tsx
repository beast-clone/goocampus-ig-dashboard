...
export default function AudiencePage() {
  ...
  return (
    <PreviewDashboardShell active="audience" title="Audience" subtitle="Who follows you across platforms — age, gender, location and when they're online.">
      {({ accountId, range }) => (
        <div className="space-y-5">
          {locked ? (
            <div className="text-[12px] text-gray-500">
              ...
              <a href="/dashboard/preview/audience#all" className="text-brand hover:underline">Audience → All platforms</a>
            </div>
          ) : (
