...
export default function AIInsightsPage() {
  return (
    <HopeDashboardShell active="ai-insights" title="AI Insights" subtitle="The quick weekly read — what worked last week and a 5-day plan for the next. (For the full report, see AI Reports.)">
