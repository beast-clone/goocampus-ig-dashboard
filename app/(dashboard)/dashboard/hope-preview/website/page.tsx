...
export default function WebsitePage() {
  return (
    <HopeDashboardShell active="website" title="Website" subtitle={`Google Analytics — ${SITE}`} hideAccountPicker>
...
function Inner({ range }: { range: { from: string; to: string } }) {
  ...
  return (
    <div className="space-y-5">
      ...
      <AiInsights endpoint={`/api/website/insights?${qs}`} accent={GA} label="Analyze this data with AI" />
