                ...
                <tr key={m.id} className={`border-b border-gray-50 last:border-0 ${m.active ? "" : "opacity-50"}`}>
                  ...
                  <td className="px-4 py-3">
                    <input
                      ...
                      className="w-56 px-2 py-1.5 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-brand text-sm"
                    />
                  </td>
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className="w-44 px-2 py-1.5 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-brand text-sm"
                      />
                      {dirty && (
                        <button
                          disabled={busy}
